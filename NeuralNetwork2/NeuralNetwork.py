...
class NeuralNetwork2:
    def __init__(self, layer_size, bit_representation , input_size, delta_cycle_nn):
        #NeuralNetwork2([6, 4, 2], 5, 12, self.delta_cycle_nn)
    ...
    def calculate(self, initial_input, gene, cycle_num):
        ...
        for layer_size in self.layer_size:
            ...
            # print('bit repr', self.bit_representation)
            # print('layer bits', layer_bits)
            # print('layer sz', layer_size)
            # print('input sz', input_size)
